...
{
    /// <summary>
    /// Provides extension methods for registering infrastructure services in the ASP.NET Core dependency injection container.
    /// </summary>
    public static class HostingExtensions
    {
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            AddCircuitBreakerResiliencePipeline(services);

            AddRefitAndResiliantHandler(services, configuration);

            AddDataLayer(services, configuration);
        ...
        /// <param name="configuration">The application configuration instance.</param>
        private static void AddRefitAndResiliantHandler(IServiceCollection services, IConfiguration configuration)
        {
        ...
        /// <param name="configuration">The application configuration instance.</param>
        private static void AddDataLayer(IServiceCollection services, IConfiguration configuration)
        {
        ...
        /// This pipeline monitors HTTP requests and temporarily blocks further requests when a specified failure threshold is reached,
        ...
        /// </summary>
        private static void AddCircuitBreakerResiliencePipeline(IServiceCollection services)
        {
